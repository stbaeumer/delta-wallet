(local icons {
              ...
              :description "<svg aria-hidden='true' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><rect x='3.5' y='3.5' width='17' height='17' rx='2' fill='currentColor' opacity='.12'/><rect x='3.5' y='3.5' width='17' height='17' rx='2' stroke='currentColor' fill='none' stroke-width='1.5'/><rect x='6' y='8' width='12' height='1.5' rx='.5' fill='currentColor'/><rect x='6' y='10.5' width='12' height='1.5' rx='.5' fill='currentColor'/><rect x='6' y='13' width='8' height='1.5' rx='.5' fill='currentColor'/></svg>"
